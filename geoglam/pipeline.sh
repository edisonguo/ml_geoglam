...
seq 1 12|$PARALLEL --will-cite -j$N_JOBS -k --joblog $FC_LOGS/h${H}v${V}.$i.parjob.log \
     $PYTHON fc_prod/main.py /g/data2/u39/public/data/modis/lpdaac-tiles-c6/ $MODEL_PATH $i {} $H $V $FC_OUTPUT \
